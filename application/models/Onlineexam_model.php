    ...
    public function onlineexamReport($condition)
    {
		...
		$this->db->select("
			...
			(SELECT COUNT(*) FROM onlineexam_students 
			 WHERE onlineexam_students.onlineexam_id = onlineexam.id) AS assign,
			(SELECT COUNT(*) FROM onlineexam_questions 
			 WHERE onlineexam_questions.onlineexam_id = onlineexam.id) AS questions
		", false);

		$this->db->from('onlineexam');
		$this->db->where($condition);
		$this->db->where('onlineexam.session_id', $this->current_session);
		$this->db->order_by('onlineexam.id', 'ASC');
