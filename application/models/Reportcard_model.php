...
class Reportcard_model extends MY_model {
    ...
    public function add($data) {
        ...
        if (isset($data['id'])) {
            ...
            $this->db->update('template_reportcard', $data);
            $message = UPDATE_RECORD_CONSTANT . " On  reportcard id " . $data['id'];
            $action = "Update";
            $record_id = $data['id'];
            ...
            $this->db->insert('template_reportcard', $data);
            $id = $this->db->insert_id();
            $message = INSERT_RECORD_CONSTANT . " On  reportcard id " . $id;
            $action = "Insert";
            $record_id = $id;
            $this->log($message, $record_id, $action);           
            //======================Code End==============================
