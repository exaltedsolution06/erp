	...
	public function examGroupSubjectResult_c($class_id, $section_id, $session_id, $exam_id)
	{
		$sql = "SELECT 
				...
				LEFT JOIN fee_groups 
					ON fee_groups.id = students.category_id
