            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><i class="fa fa-money"></i>  Fee Estimate Report</h3>
                    </div>
                                        ...
                                        <?php 
                                            ...
                                            if(in_array('Include Route', $filters)){
                                             ...
                                             if(in_array('Fees Head Wise', $filters)){
                                                ?><th style="text-align:right">Fee Head Total</th><?php
                                            }
                            ...
                            <tbody>
                                            ...
                                            if(in_array('Include Route', $filters)){
                                                ...
                                                ?>
                                                    ...
                                                    // foreach($routes as $list){ 
                                                        ...
                                                        $this->db->where('fee_group_id', $route->id);
                                                        ...
                                                        // var_dump($amt_fee_heads);

                                                        // die;
                                                        // $db_months = json_decode($db_months); die;
                                                        ...
                                                        foreach ($selected_months as $month) {
                                                            ...
                                                            // echo $month.'-'.$record["student_id"].'<br>';
                                                            ...
                                                            if (empty($receipt)) {
                                                                // echo $amt_fee_heads->amount??0;
                                                                $pay+= $amt_fee_heads->amount??0;
                                                            } else {
                                                                $final_rec1+=$receipt->month_total;
                                                                // $pay+=0;
                                                                $pay+= $amt_fee_heads->amount??0;
                                                            }
                                    ...
                                    <?php if($final+$record["fees_discount"]>0){
                                        ...
                                        <tr>
                                                ...
                                                if(in_array('Fees Head Wise', $filters)){
                                                    ...
                                                    ?>
                                                        <td style="text-align:right" >
                                                            <?php 
                                                                echo format_amount(array_sum($cat_list_amount));
                                                            ?>  
                                                        </td>
                                                    <?php  
                                            ...
                                            <td style="text-align:right"><?=format_amount(($final_rec-$oldBal))?></td>
                                            <td style="text-align:right"><?=format_amount(($final-$final_rec+$oldBal))?></td>
                                        </tr>
                                        <?php
                                ...
                                <?php endforeach; ?>
                                    <tr style="font-weight: bold;">
                                        ...
                                        <?php endif; ?>
                                          ...
                                          <?php 
                                        if (in_array('Fees Head Wise', $filters)) {
                                            ?><td style="text-align:right"><?= format_amount(array_sum($head_wise_totals)) ?></td><?php
                                        } ?>

                                        <td style="text-align:right"><?= format_amount($grand_total) ?></td>
                                        <td style="text-align:right"><?= format_amount($grand_total_1) ?></td>
                                        <td style="text-align:right"><?= format_amount($grand_total_2) ?></td>
