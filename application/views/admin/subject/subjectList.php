								...
								<div class="form-group">
									...
									foreach ($subject_types_one as $subject_type_key => $subject_type_value) {
										...
										<label class="radio-inline">
											<input type="radio" value="<?php echo $subject_type_key ?>" name="type_one" <?php echo set_radio('type_one', $subject_type_key, set_value('type_one')); ?> ><?php echo $subject_type_value; ?> 
										</label>
										<?php
									}
									?>
									<span class="text-danger"><?php echo form_error('type_one'); ?></span>
								</div>
								<div class="form-group">
