                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('branch'); ?></h3>
                        </div>
                        <form action="<?php echo site_url("admin/branch/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="branch_name" name="branch_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('branch_name', $branch['branch_name']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="db_name" name="db_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('db_name', $branch['db_name']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="db_username" name="db_username" placeholder="" type="text" class="form-control"  value="<?php echo set_value('db_username', $branch['db_username']); ?>" />
