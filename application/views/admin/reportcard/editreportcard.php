                        ...
                        <form  enctype="multipart/form-data" action="<?php echo site_url('admin/reportcard/edit/' . $reportcard->id) ?>"  id="editform" name="editform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="heading" name="heading" placeholder="" type="text" class="form-control" value="<?php echo set_value('heading', $reportcard->heading); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="exam_name" name="exam_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('exam_name', $reportcard->exam_name); ?>"/>
                                    <span class="text-danger"><?php echo form_error('exam_name'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('school_name'); ?></label>
                                    <input autofocus="" id="school_name" name="school_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('school_name', $reportcard->school_name); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="exam_center" name="exam_center" placeholder="" type="text" class="form-control" value="<?php echo set_value('exam_center', $reportcard->exam_center); ?>"/>
                                    <span class="text-danger"><?php echo form_error('exam_center'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('body_text'); ?></label>
                                    <textarea name="content" type="text" class="form-control"><?php echo set_value('content', $reportcard->content); ?></textarea>

                                    <span class="text-danger"><?php echo form_error('content'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('footer_text'); ?></label>
                                    <textarea name="content_footer" type="text" class="form-control"><?php echo set_value('content_footer', $reportcard->content_footer); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="date" name="date" placeholder="" type="text" class="form-control date" value="<?php echo set_value('date', $reportcard->date); ?>"/>
                                ...
                                <div class="form-group">
                                    <label>Footer</label>
                                    <input id="documents" name="footer_img" placeholder="" type="file" class="filestyle form-control" data-height="40"  name="background_image">
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="exam_session" name="exam_session" type="checkbox" class="chk" value="1" <?php echo set_checkbox('exam_session', '1', (set_value('exam_session', $reportcard->exam_session) == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_division" name="is_division" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_division', '1', (set_value('is_division', $reportcard->is_division) == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    <label>Footer</label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_footer" <?php echo set_checkbox('is_section', '1', (set_value('is_footer', $reportcard->is_footer) == 1) ? TRUE : FALSE); ?> name="is_footer" type="checkbox" class="chk" value="1">
                                        <label for="is_footer" class="label-success"></label>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if ($certificate->background_img != '' && !is_null($certificate->background_img)) { ?>
                                                        <img src="<?php echo base_url('uploads/reportcard/') ?><?php echo $certificate->background_img ?>" width="40">
                                                    <?php } else { ?>
