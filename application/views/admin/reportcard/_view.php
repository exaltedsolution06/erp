...
<html lang="en">
    ...
    <body class="body">
        <?php
        if ($reportcard->background_img != "") {
            ?> 
            <img src="<?php echo base_url('uploads/reportcard/' . $reportcard->background_img); ?>" class="tcmybg" width="100%" height="100%" />
            <?php
        }
        ?>
        ...
        <div style="width: 100%; margin: 0 auto; border:1px solid #000; padding: 10px 5px 5px;position: relative;">
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <?php
                if ($reportcard->heading != "" || $reportcard->title != "") {
                    ?>
                    <tr>
                        <td valign="top">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <?php
                                if ($reportcard->heading != "") {
                                    ?>
                                    <tr>
                                        <td valign="top" style="font-size: 42px; font-weight: bold; text-align: center;"><?php echo $reportcard->heading; ?></td>
                                    </tr>
                                ...
                                if ($reportcard->title != "") {
                                    ?>
                                    <tr>
                                        <td valign="top" style="font-size: 20px; font-weight: 900; text-align: center; text-transform: uppercase;"><?php echo $reportcard->title; ?></td>
                                    </tr>
                                    <?php
                                }
                                ?>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="100" valign="top" align="center" style="padding-left: 0px;">
                                    <?php
                                    if ($reportcard->left_logo != "") {
                                        ?>
                                        <img src="<?php echo base_url('uploads/reportcard/' . $reportcard->left_logo); ?>" width="100" height="100"> 
                                ...
                                <td width="100" valign="top" align="right" style="padding-right: 0px;">
                                    <?php
                                    if ($reportcard->right_logo != "") {
                                        ?>
                                        <img src="<?php echo base_url('uploads/reportcard/' . $reportcard->right_logo); ?>" width="100" height="100">
                                        <?php
                                    }
                                    ?>
                ...
                <tr>
                    <td valign="top">
                        <table cellpadding="0" cellspacing="0" width="100%" class="">
                            ...
                            <?php
                            if ($reportcard->is_class || $reportcard->is_section) {
                                ?>
                                <tr>
                                    <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('class'); ?><span style="padding-left: 30px; font-weight: bold;">
                                            ...
                                            if ($reportcard->is_class && $reportcard->is_section) {
                                                ...
                                                1 (A)
                                                <?php
                                            } elseif ($reportcard->is_class) {
                                                ?>
                                                1
                                                <?php
                                            } elseif ($reportcard->is_section) {
                                                ?>
                                                (A)
                                                <?php
                                            }
                            ...
                            ?>
                            <?php
                            if ($reportcard->school_name != "") {
                                ?>
                                <tr>
                                    <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('school_name'); ?><span style="padding-left: 30px; font-weight: bold;"><?php echo $reportcard->school_name; ?></span></td>
                                </tr>
                                <?php
                            }
                            ?>
                            <?php
                            if ($reportcard->exam_center != "") {
                                ?>
                                <tr>
                                    <td valign="top" style="text-transform: uppercase; padding-bottom: 15px;"><?php echo $this->lang->line('exam') . " " . $this->lang->line('center') ?><span style="text-transform: uppercase; padding-top: 15px; font-weight: bold; padding-bottom: 20px; padding-left: 30px;"><?php echo $reportcard->exam_center; ?></span></td>
                                </tr>
                                <?php
                            }
                            ?>
                            <?php
                            if ($reportcard->content != "") {
                                ?>
                                <tr>
                                    <td valign="top" style="text-transform: uppercase; padding-bottom: 15px; line-height: normal;"> <?php echo $reportcard->content; ?></td>
                                </tr>
                                <?php
                            }
                            ?>
                ...
                if ($reportcard->date != "") {
                    ...
                    <tr>
                        <td valign="top" style="font-weight: bold; padding-left: 30px; padding-top: 10px;"><?php echo $reportcard->date; ?></td>
                    </tr>
                    <?php
                }
                ?>
                ...
                <?php
                if ($reportcard->content_footer != "") {
                    ?>
                    <tr>
                        <td valign="top" style="text-transform: uppercase; padding-bottom: 15px; line-height: normal;"> <?php echo $reportcard->content_footer; ?></td>
                    </tr>
                    <?php
                }
                ?>
                    ...
                    <td valign="top">
                        <table cellpadding="0" cellspacing="0" width="100%" class="">
                            <tr>
                                ...
                                <?php
                                if ($reportcard->left_sign != "") {
                                    ?>
                                    <td valign="bottom" align="center" style="text-transform: uppercase;">
                                        <img src="<?php echo base_url('uploads/reportcard/' . $reportcard->left_sign); ?>"  width="100" height="50">
                                    </td>
                                    <?php
                                }
                                ?>
                                <?php
                                if ($reportcard->middle_sign != "") {
                                    ?>
                                    <td valign="bottom" align="center" style="text-transform: uppercase;">

                                        <img src="<?php echo base_url('uploads/reportcard/' . $reportcard->middle_sign); ?>" width="100" height="50">
                                    </td>
                                    <?php
                                }
                                ?>
                                <?php
                                if ($reportcard->right_sign != "") {
                                    ?>
                                    <td valign="bottom" align="center" style="text-transform: uppercase;">

                                        <img src="<?php echo base_url('uploads/reportcard/' . $reportcard->right_sign); ?>" width="100" height="50">
                                    </td>
                                    <?php
                                }
                                ?>
