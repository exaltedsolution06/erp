<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('caste_category', 'can_add') || $this->rbac->hasPrivilege('caste_category', 'can_edit')) {
                ?>
                <div class="col-md-4">              
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/caste_category/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">   
                                        ...
                                        <tr>                                         
                                            ...
                                            <td align="right" class="mailbox-date">
                                                ...
                                                if ($this->rbac->hasPrivilege('caste_category', 'can_edit')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/caste_category/edit/<?php echo $category['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('caste_category', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/caste_category/delete/<?php echo $category['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
