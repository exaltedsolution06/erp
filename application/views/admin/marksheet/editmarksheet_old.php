                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    <label>Header</label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_header" name="is_header" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_header', '1', (set_value('is_header', $marksheet->is_section) == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    <label>Footer</label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_footer" <?php echo set_checkbox('is_section', '1', (set_value('is_footer', $marksheet->is_footer) == 1) ? TRUE : FALSE); ?> name="is_footer" type="checkbox" class="chk" value="1">
