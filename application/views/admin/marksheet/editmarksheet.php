            ...
            if ($this->rbac->hasPrivilege('design_marksheet', 'can_edit')) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form  enctype="multipart/form-data" action="<?php echo site_url('admin/marksheet/edit/' . $marksheet->id) ?>"  id="editform" name="editform" method="post" accept-charset="utf-8" class="haveDropify">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="overall_marks_title" name="overall_marks_title" placeholder="" type="text" class="form-control" value="<?php echo set_value('overall_marks_title', $marksheet->overall_marks_title); ?>"/>
                                ...
                                <div class="row">
									<div class="col-md-12">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="is_header" name="is_header" type="checkbox" class="chk" value="1" onclick="valueHeaderImageChanged()" <?php echo set_checkbox('is_header', '1', (set_value('is_header', $marksheet->is_header) == 1) ? TRUE : FALSE); ?>>
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableHeaderImageDiv" hidden>
											<input id="documents" data-default-file="<?php echo base_url() ?>./uploads/marksheet/<?php echo $marksheet->header_img; ?>" name="header_img" placeholder="" type="file" class="filestyle form-control" data-height="40">
											<input type="hidden" name="remove_header_img" class="remove_image">
										</div>
									</div>
									<div class="col-md-6 col-sm-6 img_div_modal enableHeadFootDiv">
										<div class="form-group">
											<input id="header_height" name="header_height" placeholder="<?php echo $this->lang->line('header'); ?> <?php echo $this->lang->line('height'); ?>" type="number" class="form-control" min="0" value="<?php echo set_value('header_height', $marksheet->header_height); ?>" />
										</div>
									</div>
									<div class="col-md-6 col-sm-6 img_div_modal enableHeadFootDiv">
										<div class="form-group">
											<input id="footer_height" name="footer_height" placeholder="<?php echo $this->lang->line('footer'); ?> <?php echo $this->lang->line('height'); ?>" type="number" class="form-control" min="0" value="<?php echo set_value('footer_height', $marksheet->footer_height); ?>" />
										</div>
									</div>
								</div>
                                ...
                                <div class="row">
									<div class="col-md-12">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="is_class_teacher" name="is_class_teacher" type="checkbox" class="chk" value="1" onclick="valueLeftSignChanged()" <?php echo set_checkbox('is_class_teacher', '1', (set_value('is_class_teacher', $marksheet->is_class_teacher) == 1) ? TRUE : FALSE); ?>>
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableLeftSignDiv" hidden>
											<input id="documents" data-default-file="<?php echo base_url() ?>./uploads/marksheet/<?php echo $marksheet->left_sign; ?>" name="left_sign" placeholder="" type="file" class="filestyle form-control" data-height="40">
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableLeftSignDiv" hidden>
											<input autofocus="" id="left_sign_title" name="left_sign_title" placeholder="<?php echo $this->lang->line('left'); ?> <?php echo $this->lang->line('sign'); ?> <?php echo $this->lang->line('title'); ?>" type="text" class="form-control" value="<?php echo set_value('left_sign_title', $marksheet->left_sign_title); ?>"/>
                                ...
                                <div class="row">
									<div class="col-md-12">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="is_examination_ic" name="is_examination_ic" type="checkbox" class="chk" value="1" onclick="valueMiddleSignChanged()" <?php echo set_checkbox('is_examination_ic', '1', (set_value('is_examination_ic', $marksheet->is_examination_ic) == 1) ? TRUE : FALSE); ?>>
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableMiddleSignDiv" hidden>
											<input id="documents" data-default-file="<?php echo base_url() ?>./uploads/marksheet/<?php echo $marksheet->middle_sign; ?>" name="middle_sign" placeholder="" type="file" class="filestyle form-control" data-height="40">
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableMiddleSignDiv" hidden>
											<input autofocus="" id="middle_sign_title" name="middle_sign_title" placeholder="<?php echo $this->lang->line('middle'); ?> <?php echo $this->lang->line('sign'); ?> <?php echo $this->lang->line('title'); ?>" type="text" class="form-control" value="<?php echo set_value('middle_sign_title', $marksheet->middle_sign_title); ?>"/>
                                ...
                                <div class="row">
									<div class="col-md-12">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="is_principal" name="is_principal" type="checkbox" class="chk" value="1" onclick="valueRightSignChanged()" <?php echo set_checkbox('is_principal', '1', (set_value('is_principal', $marksheet->is_principal) == 1) ? TRUE : FALSE); ?>>
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableRightSignDiv" hidden>
											<input id="documents" data-default-file="<?php echo base_url() ?>./uploads/marksheet/<?php echo $marksheet->right_sign; ?>" name="right_sign" placeholder="" type="file" class="filestyle form-control" data-height="40">
									...
									<div class="col-md-12 col-sm-12 img_div_modal">
										<div class="form-group enableRightSignDiv" hidden>
											<input autofocus="" id="right_sign_title" name="right_sign_title" placeholder="<?php echo $this->lang->line('right'); ?> <?php echo $this->lang->line('sign'); ?> <?php echo $this->lang->line('title'); ?>" type="text" class="form-control" value="<?php echo set_value('right_sign_title', $marksheet->right_sign_title); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" data-default-file="<?php echo base_url() ?>./uploads/marksheet/<?php echo $marksheet->background_image; ?>" name="background_image" placeholder="" type="file" class="filestyle form-control" data-height="40"  name="background_image">
								...
								<div class="form-group">
                                    ...
                                    <input id="scholastic_area_color" name="scholastic_area_color" placeholder="" type="text" class="form-control my-colorpicker1" value="<?php echo set_value('scholastic_area_color', $marksheet->scholastic_area_color); ?>" />
                                </div>
								
								<div class="form-group">
                                    <label><?php echo $this->lang->line('main'); ?> <?php echo $this->lang->line('subject'); ?> <?php echo $this->lang->line('color'); ?></label>
                                    <input id="main_subject_color" name="main_subject_color" placeholder="" type="text" class="form-control my-colorpicker1" value="<?php echo set_value('main_subject_color', $marksheet->main_subject_color); ?>" />
                                </div>
								
								<div class="form-group">
                                    <label><?php echo $this->lang->line('subject'); ?> <?php echo $this->lang->line('color'); ?></label>
                                    <input id="subject_color" name="subject_color" placeholder="" type="text" class="form-control my-colorpicker1" value="<?php echo set_value('subject_color', $marksheet->subject_color); ?>" />
                                </div>
                                ...
                                <div class="row">
									...
									<!--<div class="col-md-6 col-sm-6 img_div_modal">
										<div class="form-group" id="enableImageDiv" hidden>
											<input id="photo_image_height" name="photo_image_height" placeholder="<?php echo $this->lang->line('photo'); ?> <?php echo $this->lang->line('height'); ?>" type="text" value="<?php echo set_value('photo_image_height', $marksheet->photo_image_height); ?>" class="form-control" min="0" />
										</div>
									</div>-->
								</div>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_contactno" name="is_contactno" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_contactno', '1', (set_value('is_contactno', $marksheet->is_contactno) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_contactno" class="label-success"></label>
                                    </div>
                                </div>
								
								<?php //foreach($exam_groups as $exam_groups_val){
									$saved_json = json_decode($marksheet->exam_group_grade, true);				
									$saved_max_marks_json = json_decode($marksheet->exam_group_max_marks, true);					
									$saved_marks_obtained_json = json_decode($marksheet->exam_group_marks_obtained, true);					
								?>
									<div class="form-group switch-inline">
										<label><?php echo $this->lang->line('show'); ?> <?php echo $this->lang->line('max'); ?> <?php echo $this->lang->line('marks'); ?> <?php //$exam_groups_val->name; ?></label>

										<div class="material-switch switchcheck">
											<input id="max_marks_0<?php //$exam_groups_val->id ?>"
												   name="max_marks[0<?php //$exam_groups_val->id ?>]"
												   type="checkbox"
												   class="chk"
												   value="1"
												   <?= isset($saved_max_marks_json[0]) && $saved_max_marks_json[0] == 1 ? 'checked' : '' ?>
											>
											<label for="max_marks_0<?php //$exam_groups_val->id ?>" class="label-success"></label>
										</div>
									</div>
									<div class="form-group switch-inline">
										<label><?php echo $this->lang->line('show'); ?> <?php echo $this->lang->line('marks'); ?> <?php echo $this->lang->line('obtained'); ?> <?php //$exam_groups_val->name; ?></label>

										<div class="material-switch switchcheck">
											<input id="marks_obtained_0<?php //$exam_groups_val->id ?>"
												   name="marks_obtained[0<?php //$exam_groups_val->id ?>]"
												   type="checkbox"
												   class="chk"
												   value="1"
												   <?= isset($saved_marks_obtained_json[0]) && $saved_marks_obtained_json[0] == 1 ? 'checked' : '' ?>
											>
											<label for="marks_obtained_0<?php //$exam_groups_val->id ?>" class="label-success"></label>
										</div>
									</div>
									<div class="form-group switch-inline">
										<label><?php echo $this->lang->line('show'); ?> <?php echo $this->lang->line('grade'); ?> <?php //$exam_groups_val->name; ?></label>

										<div class="material-switch switchcheck">
											<input id="exam_group_0<?php //$exam_groups_val->id ?>"
												   name="exam_group[0<?php //$exam_groups_val->id ?>]"
												   type="checkbox"
												   class="chk"
												   value="1"
												   <?= isset($saved_json[0]) && $saved_json[0] == 1 ? 'checked' : '' ?>
											>
											<label for="exam_group_0<?php //$exam_groups_val->id ?>" class="label-success"></label>
										</div>
									</div>
								<?php //} ?>
								<div class="form-group switch-inline">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="marks_grade_table" name="marks_grade_table" type="checkbox" class="chk" value="1" onclick="valueMarksTableChanged()" <?php echo set_checkbox('marks_grade_table', '1', (set_value('marks_grade_table', $marksheet->marks_grade_table) == 1) ? TRUE : FALSE); ?>>
									...
									<div class="col-md-12 col-sm-12 img_div_modal enableMarksTableDiv" hidden>
										<div class="form-group">
											<input id="grade_table_title" name="grade_table_title" placeholder="<?php echo $this->lang->line('grade_system'); ?>" type="text" class="form-control" value="<?php echo set_value('grade_table_title', $marksheet->grade_table_title); ?>" />
										</div>
									</div>
								</div>
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="max_marks_shift_left" name="max_marks_shift_left" type="checkbox" class="chk" value="1" <?php echo set_checkbox('max_marks_shift_left', '1', (set_value('max_marks_shift_left', $marksheet->max_marks_shift_left) == 1) ? TRUE : FALSE); ?>>
								...
								<div class="form-group switch-inline">
									...
									<div class="material-switch switchcheck">
										<input id="is_promoted_to" name="is_promoted_to" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_promoted_to', '1', (set_value('is_promoted_to', $marksheet->is_promoted_to) == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="row">
									<div class="col-md-12">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="school_reopen" name="school_reopen" type="checkbox" class="chk" value="1" onclick="valueSchoolReopenChanged()" <?php echo set_checkbox('school_reopen', '1', (set_value('school_reopen', $marksheet->school_reopen) == 1) ? TRUE : FALSE); ?>>
									...
									<div class="col-md-6 col-sm-6 img_div_modal enableSchoolReopenDiv" hidden>
										<div class="form-group">
											<input id="school_reopen_date" name="school_reopen_date" placeholder="<?php echo $this->lang->line('date'); ?>" type="text" class="form-control" value="<?php echo set_value('school_reopen_date', $marksheet->school_reopen_date); ?>" />
										</div>
									</div>
									<div class="col-md-6 col-sm-6 img_div_modal enableSchoolReopenDiv" hidden>
										<div class="form-group">
											<input id="school_reopen_time" name="school_reopen_time" placeholder="<?php echo $this->lang->line('time'); ?>" type="text" class="form-control" value="<?php echo set_value('school_reopen_time', $marksheet->school_reopen_time); ?>" />
										</div>
									</div>
								</div>
								<div class="clearfix"></div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="is_show_date" name="is_show_date" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_show_date', '1', (set_value('is_show_date', $marksheet->is_show_date) == 1) ? TRUE : FALSE); ?> onclick="valueDateChanged()">
									...
									<div class="col-md-6 col-sm-6 img_div_modal enableDateDiv" hidden>
										<div class="form-group">
											<input id="show_date" name="show_date" placeholder="<?php echo $this->lang->line('date'); ?>" type="text" class="form-control" value="<?php echo set_value('show_date', $marksheet->show_date); ?>" />
										</div>
									</div>
								</div>
								<div class="clearfix"></div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group switch-inline">
											...
											<div class="material-switch switchcheck">
												<input id="place" name="place" type="checkbox" class="chk" value="1" <?php echo set_checkbox('place', '1', (set_value('place', $marksheet->place) == 1) ? TRUE : FALSE); ?> onclick="valuePlaceChanged()">
									...
									<div class="col-md-6 col-sm-6 img_div_modal enablePlaceDiv" hidden>
										<div class="form-group">
											<input id="show_place" name="show_place" placeholder="<?php echo $this->lang->line('place'); ?>" type="text" class="form-control" value="<?php echo set_value('show_place', $marksheet->show_place); ?>" />
										</div>
									</div>
								</div>
								<div class="form-group switch-inline">
									...
									<div class="material-switch switchcheck">
										<input id="is_show_attendance" name="is_show_attendance" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_show_attendance', '1', (set_value('is_show_attendance', $marksheet->is_show_attendance) == 1) ? TRUE : FALSE); ?>>
								...
								<div class="form-group switch-inline">
									...
									<div class="material-switch switchcheck">
										<input id="is_class_position" name="is_class_position" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_class_position', '1', (set_value('is_class_position', $marksheet->is_class_position) == 1) ? TRUE : FALSE); ?>>
								...
								<!--<div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('show'); ?> <?php echo $this->lang->line('date'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_show_date" name="is_show_date" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_show_date', '1', (set_value('is_show_date', $marksheet->is_show_date) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_show_date" class="label-success"></label>
                                    </div>
                                </div>
								<div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('show'); ?> <?php echo $this->lang->line('place'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="place" name="place" type="checkbox" class="chk" value="1" <?php echo set_checkbox('place', '1', (set_value('place', $marksheet->place) == 1) ? TRUE : FALSE); ?>>
                                        <label for="place" class="label-success"></label>
                                    </div>
                                </div>-->
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('marksheet'); ?> <?php echo $this->lang->line('name'); ?></th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if ($certificate->background_image != '' && !is_null($certificate->background_image)) { ?>
                                                        <img src="<?php echo base_url('uploads/marksheet/') ?><?php echo $certificate->background_image ?>" width="40">
                                                    <?php } else { ?>
