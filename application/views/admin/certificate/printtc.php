        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/printtc/search') ?>" method="post" class="">
                    ...
                    if (isset($resultlist)) {
                        ?>
                        <form method="post" action="<?php echo base_url('admin/printtc/generatemultiple') ?>">
                            <div  class="" id="duefee">
                                ...
                                <div class="box-header ptbnull">
									...
									<?php
									if ($this->rbac->hasPrivilege('print_tc', 'can_add')) {
									?>
