...
<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('co_scholastic_areas', 'can_add')) {
                ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('co_scholastic') . " " . $this->lang->line('areas') ?></h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo site_url('admin/coscholasticareas') ?>"  id="examgroupform" name="examgroupform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="name" name="exam_group" placeholder="" type="text" class="form-control">
                                        ...
                                        foreach ($exam_group_list as $examGroup_value) {
                                            ?>
                                            <option value="<?php echo $examGroup_value->id; ?>"><?php echo $examGroup_value->name; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> Co- Scholastic Areas List</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('add_exam', 'can_view')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/coscholasticareas/addexam/<?php echo $examgroup->id ?>"
                                                    ...
                                                    if ($this->rbac->hasPrivilege('co_scholastic_areas', 'can_edit')) {
                                                        ?>
                                                        <a data-placement="left" href="<?php echo site_url('admin/coscholasticareas/edit/' . $examgroup->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('co_scholastic_areas', 'can_delete')) {
                                                        ?>
                                                        <a data-placement="left" href="<?php echo site_url('admin/coscholasticareas/delete/' . $examgroup->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
