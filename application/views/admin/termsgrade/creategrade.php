            ...
            if ($this->rbac->hasPrivilege('marks_grade', 'can_add')) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/termsgrade') ?>" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group" hidden>
                                    <label>Grade Type<small class="req">*</small></label> 
                                    <select autofocus="" id="name" name="exam_type" placeholder="" type="text" class="form-control">
                                        <option value="owerall"><?php echo $this->lang->line('select'); ?></option>
                                        <?php
                                                                ...
                                                                <tr>                
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        if ($this->rbac->hasPrivilege('marks_grade', 'can_edit')) {
                                                                            ?>
                                                                            <a data-placement="left" href="<?php echo base_url(); ?>admin/termsgrade/edit/<?php echo $grade_value->id; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                        ...
                                                                        if ($this->rbac->hasPrivilege('marks_grade', 'can_delete')) {
                                                                            ?>
                                                                            <a data-placement="left" href="<?php echo base_url(); ?>admin/termsgrade/delete/<?php echo $grade_value->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
