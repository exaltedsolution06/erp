                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            if (empty($resultlist)) {
								...
								<?php if ($this->rbac->hasPrivilege('exam_marks', 'can_add')) { ?>
                                <td> <input type="number" class="marksssss form-control" name="exam_group_student_mark_<?php echo $student['exam_group_class_batch_exam_students_id']; ?>" value="<?php echo $student['exam_group_exam_result_get_marks'] > 0 ? format_amount($student['exam_group_exam_result_get_marks']) : ''; ?>" step="any"></td>
