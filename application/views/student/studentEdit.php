                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="other_no" name="other_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('other_no', $student['other_no']); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <select class="form-control" id="vehroute_id" name="vehroute_id">
                                                        ...
                                                        foreach ($vehroutelist as $vehroute) {
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                            <option value="<?=$vehroute['id']?>"><?=$vehroute['fees_heading']?></option>
                                                            <?php
                                                            }
...
<?php }if ($sch_setting->father_pic) { ?>
                                        ...
                                        <?php } ?>
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pen_no" name="father_pan_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('father_pan_no', $student['father_pan_no']); ?>" />
                                                <span class="text-danger"><?php echo form_error('pen_no'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="aadhar_no" name="father_aadhar_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('father_aadhar_no', $student['father_aadhar_no']); ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="other_no" name="father_other_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('father_other_no', $student['father_other_no']); ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Father ID No.</label>
                                                <input id="other_no" name="father_id_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('father_id_no', $student['father_id_no']); ?>" />
                                            </div>
                                        </div>
...
<?php } ?>
                                 ...
                                 <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pen_no" name="mother_pan_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('mother_pan_no', $student['mother_pan_no']); ?>" />
                                                <span class="text-danger"><?php echo form_error('pen_no'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="aadhar_no" name="mother_aadhar_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('mother_aadhar_no', $student['mother_aadhar_no']); ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="other_no" name="mother_other_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('mother_other_no', $student['mother_other_no']); ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Mother ID No.</label>
                                                <input id="other_no" name="mother_id_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('mother_id_no', $student['mother_id_no']); ?>" />
                                            </div>
                                        </div>
