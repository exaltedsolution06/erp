            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="pull-right box-tools impbtntitle">
                        <?php if ($this->rbac->hasPrivilege('import_admission', 'can_add')) { ?>
                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">                       
                        <div class="">
                            <div class="bozero">
                                ...
                                <h5 style="padding-left:10px;color:green">Last Admission No. - <?=$admission_no?></h5>
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pen_no" name="pen_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('pen_no'); ?>" />
...
<?php } if ($sch_setting->father_pan) { ?>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pen_no" name="father_pan_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('father_pen_no'); ?>" />
                                                <span class="text-danger"><?php echo form_error('pen_no'); ?></span>
                                            </div>
                                        </div>
...
<?php } if ($sch_setting->mother_pan) { ?>
                                    <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="pen_no" name="mother_pan_no" placeholder="" type="text" class="form-control "  value="<?php echo set_value('mother_pen_no'); ?>" />
                                                <span class="text-danger"><?php echo form_error('pen_no'); ?></span>
                                            </div>
                                        </div>
