                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                         ...
                         <?php
                            ...
                            if ($this->rbac->hasPrivilege('fees_master', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('feetype/setroute'); ?>"><a href="<?php echo base_url(); ?>admin/feesroutes/index"><i class="fa fa-angle-double-right"></i> Set Route</a></li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->module_lib->hasActive('multi_class')) {
                                if ($this->rbac->hasPrivilege('multi_class_student', 'can_view')) {
                                    ?>
                                    <li class="<?php echo set_Submenu('student/multiclass'); ?>"><a href="<?php echo base_url(); ?>student/multiclass"><i class="fa fa-angle-double-right"></i> Reports</a></li>
                                    <?php
                                }
                            }
...
if ($this->module_lib->hasActive('fees_collection')) {
                    ...
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('fees_carry_forward', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('feesforward/index'); ?>"><a href="<?php echo base_url('admin/feesforward'); ?>"><i class="fa fa-angle-double-right"></i> Fee Remirnder</a></li>
                                <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('fees_reminder', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('feereminder/setting'); ?>"><a href="<?php echo site_url('report/finance'); ?>"><i class="fa fa-angle-double-right"></i> Fee Reports</a></li>
                                <?php
                            }
                            ?>
            ...
            if ($this->module_lib->hasActive('student_attendance')) {
                if (($this->rbac->hasPrivilege('student_attendance', 'can_view') ||
                    ...
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Attendance'); ?>" style="margin-top:10px" >
                        <a href="#">
                    ...
                    <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('exam_group', 'can_view')) { ?>
                                <li class="<?php if($this->uri->segment(2)=='examgroup'){ echo 'active'; } ?>"><a href="<?php echo site_url('admin/examgroup'); ?>"><i class="fa fa-angle-double-right"></i>Terms</a></li>
                            <?php }
                            ?>
                            ...
                            if ($this->rbac->hasPrivilege('marks_grade', 'can_view')) {
                             ...
                             if ($this->rbac->hasPrivilege('marks_grade', 'can_view')) {
                                ?>
                                <li class="<?php if($this->uri->segment(2)=='termsgrade'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>admin/termsgrade"><i class="fa fa-angle-double-right"></i> Terms Grade</a></li> <?php } ?>    
    ...
    if (($this->rbac->hasPrivilege('upload_content', 'can_view'))) {
        ...
        <?php } ?>
            ...
            ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('ticket'); ?>">
                        <a href="#">
                            <i class="fa fa-newspaper-o ftlayer"></i> <span>Ticket Section</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                          
                            <li class="<?php echo set_Submenu('admin/create'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Create Ticket</a></li>
                            
                            <li class="<?php echo set_Submenu('admin/track'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Track Ticket</a></li>
                            
                        
                            <li class="<?php echo set_Submenu('admin/closed'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Closed Ticket</a></li>
                        </ul>
                    </li>
...
<li class="treeview <?php echo set_Topmenu('multi_branch'); ?>">
                        <a href="#">
                            <i class="fa fa-newspaper-o ftlayer"></i> <span>Multi Branch </span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                          
                            <li class="<?php echo set_Submenu('admin/create'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Overview</a></li>
                            
                            <li class="<?php echo set_Submenu('admin/track'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Report</a></li>
...
<li class="treeview <?php echo set_Topmenu('service'); ?>">
                        <a href="#">
                            <i class="fa fa-newspaper-o ftlayer"></i> <span>Software Service</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                          
                            <li class="<?php echo set_Submenu('admin/create'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Package List</a></li>
                            
                            <li class="<?php echo set_Submenu('admin/track'); ?>"><a href=""><i class="fa fa-angle-double-right"></i>Invoice Details</a></li>
