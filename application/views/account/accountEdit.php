        ...
        <div class="row">
            <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("account/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="section" name="section" placeholder="" type="text" class="form-control"  value="<?php echo set_value('account', $section['account']); ?>" />
