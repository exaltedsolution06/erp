        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('account/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Account Name </label><small class="req"> *</small>
