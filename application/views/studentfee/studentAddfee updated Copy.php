                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
												...
												<?php if ($this->rbac->hasPrivilege('assign_discount', 'can_add')) { ?>
                                                <th><input type="text" style="width: 100px;" class="rec_discount" name="rec_discount[]" id="total_get_discount_<?=$aa?>" oninput="calculateDisData(this,<?=$aa?>)" value=""></th>
												<?php } ?>
                                            ...
                                            ?>
											<tr>
												<th><input type="checkbox"  onchange="DeleteRowData(this,<?=$aa?>)" checked />
                                                </th>
                                                <th>LEDG AMT</th>
												<?php foreach($months_data as $key=>$value){
												?>
                            ...
                            <div class="container" style="overflow-x: auto; max-width: 100%;">
                                ...
                                <div class="row " style="display:flex; margin-top: 10px !important;">
									...
									<div class="col-sm-2">
                                        ...
                                        <input style="width: 100%;" type="text" id="total_payable_amt" class="form-control" value="<?=$final_total?>" name="total_payable_amt" readonly />
                                    </div>
                                    <div class="col-sm-2">
