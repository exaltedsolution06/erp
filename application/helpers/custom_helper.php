...
if (!function_exists('sort_by_custom_month_order')) {
    function sort_by_custom_month_order($monthString) {
        // Step 1: Explode the string into an array
        $data = explode(',', $monthString);

        // Step 2: Custom month order from April to March
        $customOrder = ['Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar'];

        // Step 3: Sort using custom order
