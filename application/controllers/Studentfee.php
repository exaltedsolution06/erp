...
class Studentfee extends Admin_Controller
{
    ...
    public function saveFee(){
        ...
        if(!empty($data['pay'][0])){
			...
			$total_fees_discount = (int)$data['balance_amt']-(int)$data['prev_row_balance']-(int)$data['ledg_rec_discount'];
