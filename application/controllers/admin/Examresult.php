...
class Examresult extends Admin_Controller {
    ...
    public function printmarksheet() {
        ...
        $data['post_exam_group_id']=$this->db->query("SELECT * FROM exam_groups WHERE id='$post_exam_group_id'")->result();
           ...
           // var_dump($data['post_exam_group_id']);
        $student_admit_cards = $this->load->view('admin/examresult/printmarksheet1',$data);
    ...
    public function reportcard(){
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('admin/examresult/reportcard', $data);
        $this->load->view('layout/footer', $data);
    ...
    public function printreportcard() {
        ...
        */
        ...
        $query = $this->db->query($sql);       
        $data['marksheet'] = $query->result();
        $data['reportcard'] = $this->reportcard_model->get($this->input->post('reportcard'));
