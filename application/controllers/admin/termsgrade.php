...
class termsgrade extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_menu','Examinations/termsgrade');
        $data['title']      = 'Add Arade';
        $data['title_list'] = 'Grade Details';
        $listgrade          = $this->grade_model->getGradeDetails1();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admin/termsgrade/creategrade', $data);
            ...
            redirect('admin/termsgrade/index');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layout/header');
            $this->load->view('admin/termsgrade/editgrade', $data);
            $this->load->view('layout/footer');
        } else {
            $data = array(
